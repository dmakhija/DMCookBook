...
using DMCookBook.Data;
using DMCookBook.Common;
...
namespace DMCookBook
{
    ...
    public sealed partial class HubPage : Page
    {
        ...
        public int GetRandomNumber(int maxValue)
        {
            ...
            return a.Next(1, maxValue);
        }

        //click event of international cusine list item
        private void groupListView_ItemClick(object sender, ItemClickEventArgs e)
        {
            // Navigate to the appropriate destination page, configuring the new page
            // by passing required information as a navigation parameter
            var itemId = ((SampleDataGroup)e.ClickedItem).Id;
        ...
        */
        ...
        void Hub_SectionHeaderClick(object sender, HubSectionHeaderClickEventArgs e)
        {
            ...
            this.Frame.Navigate(typeof(SectionPage), ((SampleDataGroup)group).Id);
        }
